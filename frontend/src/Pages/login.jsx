...
// ─── Shared components (imported from Components folder) ───────────────────────
// import { Logo, InputField, PasswordField, GoogleButton, Divider } from "./components";
// Inlined here for reference — replace with your actual imports:
...
const WelcomeBack = () => (
  <div className="relative z-10 space-y-6 mb-14">
    <div className="space-y-2">
      <h2 className="text-3xl font-bold text-white leading-snug">
        Welcome back<br />to FinSight.
      </h2>
      <p className="text-indigo-200 text-sm leading-relaxed">
        Your finances haven't stopped while you were away. Pick up right where you left off.
      </p>
    </div>
  </div>
);
